        ...
        <div className="flex items-center justify-between h-14">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:inline-flex items-center gap-2 px-3 py-1.5 text-sm bg-[var(--accent)] text-[var(--background)] rounded-button hover:opacity-80 transition-opacity"
            >
